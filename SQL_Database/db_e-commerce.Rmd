...
CREATE TABLE IF NOT EXISTS customer(
  ...
  cust_password md5(VARBINARY(64)) NOT NULL,
  cust_phone INT (15) UNIQUE NOT NULL,
  cust_zipcode VARCHAR (10),
  cust_city VARCHAR (50),
  cust_street_address VARCHAR (255),
  score INT,
  mem_id ENUM ('1', '2', '3', '4') AS (
    CASE
      WHEN score > 1000 THEN '1'
      WHEN score > 500 THEN '2'
...
CREATE TABLE IF NOT EXISTS product(
  ...
  FOREIGN KEY (prod_category_id) REFERENCES prod_category(prod_category_id)
);
```
